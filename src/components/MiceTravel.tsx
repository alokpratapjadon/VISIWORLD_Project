...
import miceTravelVideo from '../Assets/mice1.mp4';

const MiceTravel = () => {
  const images = [
    { src: wedding1, title: 'Corporate Meetings', desc: 'Seamless planning for meetings and conferences' },
    { src: wedding2, title: 'Incentive Travel', desc: 'Reward programs designed to motivate and inspire' },
    { src: wedding3, title: 'Event Management', desc: 'Comprehensive support for corporate events' },
  ];
    ...
    <div className="bg-[#fcf9ed] text-[#333] font-poppins relative">
      ...
      <section className="relative w-full h-screen overflow-hidden">
        ...
        <div className="relative z-20 h-full flex flex-col justify-center items-center text-center px-6">
          ...
          >
            Meetings, Incentives, Conferences, and Events with seamless corporate travel solutions.
          </motion.p>
        </div>
      </section>
          ...
          {[
            {
              ...
              text: 'Expert coordination of corporate meetings and conferences.',
            },
            {
              title: 'Incentive Programs',
              text: 'Tailored travel rewards to boost employee motivation.',
            },
            {
              title: 'Event Logistics',
              text: 'Comprehensive management of event details and execution.',
            },
          ].map((item, i) => (
            <motion.div
              key={i}
      ...
      >
        <p className="text-lg md:text-xl font-medium text-gray-700">
          ...and much more to make your corporate travel seamless and successful.
        </p>
        <p className="mt-2 text-sm text-yellow-700 italic">
          From planning to execution, every detail handled with precision.
        </p>
      </motion.div>
